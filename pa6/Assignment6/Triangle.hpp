...
{
public:
    MeshTriangle(const std::string& filename, const std::string& sp_method)
    {
        objl::Loader loader;
        ...
        bvh = new BVHAccel(ptrs, 1, (sp_method == "sah")?BVHAccel::SplitMethod::SAH:BVHAccel::SplitMethod::NAIVE);
    }
